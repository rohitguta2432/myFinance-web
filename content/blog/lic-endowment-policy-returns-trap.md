---
title: "The ₹40 Lakh Endowment Trap: LIC Returns Below Inflation"
description: "Most ₹15L+ earners hold endowment policies returning 4–5% IRR. The math on LIC bonus rates vs term + index fund — and the ₹40L gap."
...
If you have never calculated your **endowment policy returns**, you are not alone. Most policyholders haven't. And LIC, your bank, and your relationship manager have no commercial reason to show you. The number sits between [4% and 6%](https://www.finnovate.in/learn/blog/term-vs-endowment-vs-ulip-insurance-comparison-explained) — before inflation.

Indian CPI has averaged ~6% for the last two decades ([MoSPI series](https://mospi.gov.in/)). Your "guaranteed" policy is a real-return-negative product wrapped in marketing about discipline and safety.
...
The critical word in that formula is *simple*. Reversionary bonus on Indian endowment policies [accumulates linearly, not compoundly](https://www.basunivesh.com/lic-policies-how-to-calculate-returns/).

Take a ₹10 lakh sum assured. LIC's bonus rate on its main endowment plan has hovered around ₹40–46 per ₹1,000 SA in recent years ([Plan 914 bonus history](https://www.policybazaar.com/lic-of-india/articles/lic-endowment-plan-bonus-rate/)).

Year 1 bonus: ₹42 × 1,000 = ₹42,000.
Year 2 bonus: ₹42,000 again. Not ₹42,000 × 1.05.
...
Compare that to compounding. ₹42,000 invested at 11% — the [25-year Nifty 50 TRI long-run CAGR](https://www.niftyindices.com/market-data/return-profile) — becomes ~₹5.6 lakh in 25 years. At 8%, a conservative debt-equity blend, it becomes ~₹2.9 lakh.
...
A bank FD over the same period averaged 6.5–7.5%. A boring [PPF](https://www.indiapost.gov.in/Financial/Pages/Content/Public-Provident-Fund-Account.aspx) returned 7.5–8.7%, fully tax-free. A Nifty 50 index fund returned ~11% with full liquidity after Year 1.

The endowment underperformed every safer or more liquid alternative.

## "Buy term, invest the rest" — the math

Same 30-year-old. ₹1 crore term cover from any IRDAI-approved insurer: ~[₹10,000/year](https://www.policybazaar.com/term-insurance/articles/term-insurance-vs-endowment-policy/) for a non-smoker.

That frees up ₹42,000/year (₹52,000 endowment premium minus ₹10,000 term).

Invest ₹42,000/year for 25 years at 11% (Nifty 50 TRI long-term):
**Future value ≈ ₹56 lakh.**
...
**2. Surrendering at the wrong time.** [Guaranteed Surrender Value is 30% of paid premiums](https://www.advisorkhoj.com/articles/Life-Insurance/Should-you-surrender-your-life-insurance-endowment-policy) (excluding year 1) for the early years. Special Surrender Value is usually higher. Most people exit on GSV without checking SSV. Cost: 10–25% of corpus.
...
**5. Letting a relationship manager renew without disclosure.** Year-1 commission on endowment is materially higher than on a term plan ([IRDAI commission structure](https://irdai.gov.in/)). Your "advisor" earns far more selling you the wrong product. Cost: a lifetime of similar recommendations.
...
**What is the actual return on an LIC endowment policy?**
[4–6% IRR](https://www.finnovate.in/learn/blog/term-vs-endowment-vs-ulip-insurance-comparison-explained) for most plans, calculated on net cashflows from premium to maturity. The simple (non-compounding) bonus structure is the main reason endowment policy returns lag every other instrument over a 20+ year horizon, including a vanilla bank FD.

**Should I surrender my endowment policy?**
Depends on years paid, current paid-up value, and whether you can pass underwriting for a fresh term policy. Get the [SSV quote](https://www.advisorkhoj.com/articles/Life-Insurance/Should-you-surrender-your-life-insurance-endowment-policy), compare to expected returns from redeploying — but only after a new term policy is issued.

**Is endowment policy a good investment in India?**
No. It is a bond-equivalent return with insurance bundled in. Both the insurance and the investment are weaker than what you'd get buying them separately.

**How much will I get if I surrender my LIC policy after 5 years?**
[GSV](https://1finance.co.in/calculator/surrender-value) = 30% × (premiums paid – year 1 premium). SSV may be higher depending on bonuses. After 5 years on a ₹50K premium, expect ₹60K–1.1L back from a ₹2L outflow.

**Term insurance + mutual fund vs endowment — which is better?**
Term + index fund delivers [3–5× higher maturity wealth](https://www.wealthease.in/post/term-insurance-plus-mutual-funds-strategy) over 25 years with 5–10× higher death cover. The trade-off: you have to keep the SIP running. Most who can earn ₹15L+ can.

## Get your blind spots in 15 minutes

Most professionals I work with have at least one blind spot like this. The free Essentials diagnostic surfaces yours in 15 minutes → [myfinancial.in](https://myfinancial.in)
