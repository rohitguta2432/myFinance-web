...
export function FinalCTASection() {
    ...
    return (
        <section style={{ textAlign: "center", padding: "clamp(100px, 14vw, 180px) 0", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ maxWidth: 1120, margin: "0 auto", padding: "0 2rem", position: "relative" }}>
                <h2 className="landing-h2-lg" style={{ fontFamily: "var(--font-display)", fontWeight: 800, lineHeight: 1.08, letterSpacing: "-1.5px", maxWidth: 700, margin: "0 auto 20px", color: palette.txt }}>
                ...
                <p style={{ fontFamily: "var(--font-serif)", fontSize: 16, color: palette.mute, lineHeight: 1.75, maxWidth: 440, margin: "0 auto 36px", fontStyle: "italic", textAlign: "center" }}>
                    {showPricing
                        ...
                        : "One form. Instant dashboard. The clearest picture you've ever had."}
                </p>
                ...
                <div style={{ fontFamily: "var(--font-display)", fontSize: 13, color: palette.mute, marginTop: 20, display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                    ...
                    {showSebi && <><span>·</span><span>SEBI RIA In Progress</span></>}
                    <span>·</span><span>No product selling</span>
                </div>
            </div>
        </section>
    );
