                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-start">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span style={{ fontSize: "2.25rem", fontWeight: 800, color: palette.s3 }}>01</span>
                            </div>
                            <h2 className="text-h2" style={{ color: palette.txt, marginBottom: 16 }}>Enter Your Numbers</h2>
                            <p className="text-body" style={{ color: palette.mute, marginBottom: 32, maxWidth: 500, lineHeight: 1.7 }}>
                        ...
                        <div className="grid grid-cols-2 gap-3" style={{ maxWidth: 340 }}>
                            {step1SubItems.map((item, i) => (
                                ...
                                >
                                    ...
                                    <h4 style={{ fontSize: 14, fontWeight: 700, color: palette.txt, marginBottom: 2 }}>{item.title}</h4>
                                    <p style={{ fontSize: 11, color: palette.mute, lineHeight: 1.4 }}>{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <section className="section-padding" style={{ backgroundColor: palette.s1 }}>
                <div className="container-marketing">
                    <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-12 items-start">
                        ...
                        <div style={{ maxWidth: 400 }} className="space-y-4">
                            {step2SubItems.map((item, i) => (
                                <div key={i} className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 style={{ fontSize: 14, fontWeight: 700, color: palette.txt, marginBottom: 2 }}>{item.title}</h4>
                                        <p style={{ fontSize: 12, color: palette.mute, lineHeight: 1.6 }}>{item.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span style={{ fontSize: "2.25rem", fontWeight: 800, color: palette.s3 }}>02</span>
                            </div>
                            <h2 className="text-h2" style={{ color: palette.txt, marginBottom: 16 }}>Instant Browser Analysis</h2>
                            <p className="text-body" style={{ color: palette.mute, maxWidth: 500, lineHeight: 1.7 }}>
            ...
            <section className="section-padding" style={{ backgroundColor: palette.bg }}>
                <div className="container-marketing">
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-start">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span style={{ fontSize: "2.25rem", fontWeight: 800, color: palette.s3 }}>03</span>
                            </div>
                            <h2 className="text-h2" style={{ color: palette.txt, marginBottom: 16 }}>Your Financial Report</h2>
                            <p className="text-body" style={{ color: palette.mute, marginBottom: 32, maxWidth: 500, lineHeight: 1.7 }}>
                        ...
                        <div className="grid grid-cols-3 gap-3" style={{ maxWidth: 380 }}>
                            {step3SubItems.map((item, i) => (
                                ...
                                >
                                    ...
                                    <h4 style={{ fontSize: 12, fontWeight: 700, color: palette.txt, marginBottom: 2 }}>{item.title}</h4>
                                    <p style={{ fontSize: 10, color: palette.mute }}>{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <section className="section-padding" style={{ backgroundColor: palette.s1 }}>
                <div className="container-marketing text-center">
                    ...
                    >
                        ...
                        <h3 className="text-h3" style={{ color: palette.txt, marginBottom: 12 }}>Your data never leaves your browser</h3>
                        <p className="text-body" style={{ color: palette.mute, marginBottom: 24 }}>
