  ...
  if (!regimeComparison) {
    return (
      <div style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: 40, height: 40, borderRadius: "50%", borderStyle: "solid", borderWidth: 3, borderTopColor: "#10B981", borderRightColor: "rgba(16,185,129,0.3)", borderBottomColor: "rgba(16,185,129,0.3)", borderLeftColor: "rgba(16,185,129,0.3)", animation: "spin 1s linear infinite" }} />
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {[
                  ...
                  { label: "Section 80C", old: oldR.deductions80C, new: newR.deductions80C },
                  { label: "NPS 80CCD", old: oldR.deductionsNps, new: newR.deductionsNps },
                  { label: "HRA Exemption", old: oldR.hraExemption ?? 0, new: newR.hraExemption ?? 0 },
                  { label: "Other Deductions", old: oldR.otherDeductions ?? 0, new: newR.otherDeductions ?? 0 },
