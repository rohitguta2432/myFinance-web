        ...
        <>
            ...
            <section className="section-padding" style={{ backgroundColor: palette.bg }}>
                <div className="container-marketing text-center">
                    ...
                    <h1 className="text-h1" style={{ color: palette.txt, maxWidth: 600, marginLeft: "auto", marginRight: "auto", marginBottom: 20 }}>
            ...
            <section className="section-padding" style={{ backgroundColor: palette.s1 }}>
                <div className="container-marketing">
                    <h2 className="text-h3 text-center" style={{ color: palette.txt, marginBottom: 48 }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" style={{ maxWidth: 1000, marginLeft: "auto", marginRight: "auto" }}>
                        {principles.map((p, i) => (
                            ...
                            >
                                ...
                                <h3 style={{ fontSize: 16, fontWeight: 600, color: palette.txt, marginBottom: 8 }}>
                                    {p.title}
                                </h3>
                                <p className="text-body-sm" style={{ color: palette.mute, lineHeight: 1.6 }}>
                                    {p.description}
                                </p>
                            </div>
                        ))}
            ...
            <section className="section-padding" style={{ backgroundColor: palette.bg }}>
                <div className="container-marketing" style={{ maxWidth: 700 }}>
                    <h2 className="text-h3" style={{ color: palette.txt, marginBottom: 32 }}>Technical implementation</h2>

                    <div className="space-y-8">
                        <div>
                            <h3 className="text-h4" style={{ color: palette.txt, marginBottom: 12 }}>How localStorage works</h3>
                        ...
                        <div>
                            <h3 className="text-h4" style={{ color: palette.txt, marginBottom: 12 }}>What we store</h3>
                            <p className="text-body" style={{ color: palette.mute, lineHeight: 1.7 }}>
                        ...
                        <div>
                            <h3 className="text-h4" style={{ color: palette.txt, marginBottom: 12 }}>Data lifecycle</h3>
                            <p className="text-body" style={{ color: palette.mute, lineHeight: 1.7 }}>
            ...
            <section className="section-padding" style={{ backgroundColor: palette.s1 }}>
                <div className="container-marketing text-center" style={{ maxWidth: 500 }}>
                    <h2 className="text-h3" style={{ color: palette.txt, marginBottom: 16 }}>Questions about privacy?</h2>
                    ...
                    <p className="text-caption" style={{ color: palette.mute, marginTop: 24 }}>
